...
export const HowItWorks: React.FC = () => {
  ...
  const steps = [
    {
      ...
      description: 'Autonomous AI agents deposit real assets (USDC) into VaultManager. Collateral is segregated and locked 1:1 against issued service level agreements.',
    ...
    },
    {
      ...
      description: 'Users choose an SLA protection term with a fixed premium, known duration, and transparent maximum payout. Coverage is minted on-chain via CoverageManager.',
    ...
    },
    {
      ...
      description: 'When an eligible SLA failure condition is verified, ClaimsProcessor releases locked collateral from the bonded vault directly to the user—no delays, no claims adjusters.',
  ...
  return (
    <section className="how-it-works-section" id="how-it-works" ref={sectionRef as React.RefObject<HTMLElement>}>
      <div className="container">
        ...
        <div className="steps-grid">
          {steps.map((step, idx) => (
            <div key={step.num} className={`step-card glass-panel reveal reveal-delay-${idx + 1}`}>
        ...
        {/* Video Guide Banner */}
        <div className="video-guide-banner glass-panel reveal">
        ...
        <div className="video-modal-backdrop" onClick={() => setVideoModalOpen(false)}>
          <div className="video-modal-card glass-panel" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              ...
              <button className="modal-close-btn" aria-label="Close video" onClick={() => setVideoModalOpen(false)}>✕</button>
            </div>
